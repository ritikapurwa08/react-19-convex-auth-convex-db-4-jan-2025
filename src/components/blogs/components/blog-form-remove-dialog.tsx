...
import { UseRemoveBlogHook } from "../hooks/blog-interaction-hook";

interface BlogFormRemoveDialogProps {
  blogId: Id<"blogs">;
}

const BlogFormRemoveDialog: React.FC<BlogFormRemoveDialogProps> = ({
  blogId,
}) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="destructive" size="icon" disabled={isRemovingBlog}>
...
export default BlogFormRemoveDialog;
